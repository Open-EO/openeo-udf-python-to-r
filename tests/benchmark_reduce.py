...
with tempfile.TemporaryDirectory() as folder:
    ...
    print('UDF chunked')
    run('reduce_dimension', './tests/udfs/reduce_chunked.R', folder, dimension = d)

    # print('UDF vectorized')
    # run('reduce_dimension', './tests/udfs/reduce.R', folder, dimension = d)

    # print('Native R')
    # measure_r('reduce_dimension', './tests/udfs/reduce_timer.R', folder, dimension = d)
